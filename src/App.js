    ...
    axios
      ...
      .then(response => {
        ...
        this.setState({
          ...
          backgroundType: filteredList[0].weather[0].main
        });
      });
  }
        ...
        <>
          <div className="container">
            <div
              style={{
                background: `url(${
                  backgrounds[this.state.backgroundType]
            ...
            >
              <div style={{ color: "white" }} className="card-content">
                {this.state.weatherData.map(day => {
                  let imgIcon = `https://openweathermap.org/img/wn/${
                    day.weather[0].icon
                  }@2x.png`;
                  return (
                    <>
                        ...
                        <div className="days">
                          ...
                          <div>
                            <h4 className="col s6 l12 m12 day white-text">
                              {this.generateDayOfTheWeek(day.dt_txt)}
                            </h4>
                            <img
                              className="col s3"
                              id="weatherIcon"
                          ...
                          <h5 className="degree">
                            ...
                            <sup>&#xb0;</sup>{" "}
                            <span
                              style={{ marginLeft: "5px", fontWeight: 200 }}
                            >
